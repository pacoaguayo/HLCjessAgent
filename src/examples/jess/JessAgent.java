...
@version $Date: 2000-09-12 15:24:08 +0200 (mar 12 de sep de 2000) $ $Revision: 1857 $
*/
...
public class JessAgent extends Agent {
  ...
  protected void setup() {
    ...
    String jessAgentsPath   = "nodes/jessAgents/";
    String jessDefaultName  = "JadeAgent.clp";
    int maxJessPasses       = 1;
    
    Object[] args = getArguments();
    if (args != null) {
      for (int i = 0; i < args.length; ++i) {
         if (i == 0) { jessDefaultName = args[i].toString();      }
         if (i == 1) { maxJessPasses   = Integer.parseInt(args[i].toString()); }
         System.out.println("- "+args[i]);
      }
    }
    
    String jessFile         = jessAgentsPath + jessDefaultName;
   
    addBehaviour(new BasicJessBehaviour(this, jessFile, maxJessPasses)); 
  }
}
